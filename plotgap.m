function plotgap(Pmin, Pmax, A,n)
...
for i=1:a
 ...
 title(['n=3, \alpha= ', num2str(alpha), ', c=',num2str(c(i)),', C=',num2str(C(i)),])
 ...
 graph_name=["W_(n,P)_n=3_Pmin=" num2str(Pmin) "_Pmax=" num2str(Pmax) "_alpha=" num2str(alpha) "_low"".jpg"];
 print(graph_name)
